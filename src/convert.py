...
# 定义数据路径
data_path ='/Users/bachmar/wiridt/wirelessIdentification/data/scoliosis'
new_data_path = '/Users/bachmar/wiridt/wirelessIdentification/data/scoliosis'

# 动作标签
actions = ['cyd','dsy','gxq','ljy','zzy']
